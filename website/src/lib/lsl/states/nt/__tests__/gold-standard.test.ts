// NT engine gold-standard fixture runner.
// Audit trail: docs/qa/test-cases-nt.md v1.0 PM-signed 2026-05-27;
// Scaffold task: T9.1 (smoke fixture TC-NT-001); full corpus lands in T9.3.
// Mirrors the TAS gold-standard runner exactly (see tas/__tests__/gold-standard.test.ts).
