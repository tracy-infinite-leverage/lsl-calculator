// NT engine bulk-mode fixture runner.
// Audit trail: docs/qa/test-cases-nt.md v1.0 PM-signed 2026-05-27;
// Authored in T9.3 alongside the 75 single-mode corpus.
// Mirrors the TAS bulk runner exactly (see tas/__tests__/bulk.test.ts).
...
describe('NT bulk-mode fixtures', () => {
