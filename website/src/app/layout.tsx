...
export const metadata: Metadata = {
  ...
  description:
    'Defensible long-service-leave calculator for Australian payroll. NSW, VIC, QLD, WA, SA available — ACT, TAS, NT coming soon. Every output is citation-backed to the source statute.',
  openGraph: {
    title: 'LSL Calculator',
    description:
      'Defensible long-service-leave calculator for Australian payroll. NSW, VIC, QLD, WA, SA available — ACT, TAS, NT coming soon.',
    type: 'website',
  },
};
