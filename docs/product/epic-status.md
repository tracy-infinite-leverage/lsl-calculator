# LSL Calculator · Epic Status · Last updated: 2026-05-25 · E1 NSW SHIPPED (Phases 1+2+3 live on lsl-calculator.vercel.app) · E2 Phase 1+3+4 merged to main (PR #8 at `56ae5fd`, PR #10 at `93484f3`, PR #11 at `0bddbbc`, PR #13 QLD engine, PR #14 DEV-CROSS-1 `bd2d284` — VIC + QLD engines LIVE) · E2 Phase 4 T4.0 QLD test-cases v1.1 — all 5 previously deferred DEV-CROSS-1 fixtures reinstated (57 active single + 3 bulk = 60 total)
...
- **Next action**: Phase 2 (mixed-state bulk CSV foundation) continues in parallel; Phase 5 (WA) is next on the state queue per RES-1 priority order.
